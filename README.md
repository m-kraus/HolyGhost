...
At the time of writing this is https://github.com/casperjs/casperjs/archive/1.1.4-2.tar.gz

    cd /opt
    sudo tar xzvf Downloads/1.1.4-2.tar.gz
    sudo ln -s casperjs-1.1.4-2 casperjs
